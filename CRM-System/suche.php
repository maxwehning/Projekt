...
<header>
    <h1 id="pageTitle">Kundensuche</h1>
</header>

<nav>
    <div class="link-container">
        <a href="#" class="link" onclick="event.preventDefault();"><i class="bi bi-house"></i> Startseite</a>
        <a href="#" class="link" onclick="event.preventDefault(); switchTab('benutzerdaten')"><i class="bi bi-search"></i> Kundensuche</a>
...
<section id="mainContent">
    <div class="container">
        <form action="kundeSuchen.php" method="GET">
            ...
            <button type="submit" class="btn"><i class="bi bi-search"></i> Suchen</button>
        </form>
    </div>
</section>
